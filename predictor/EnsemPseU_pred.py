...
def main():
    ...
    parser.add_argument('--species',dest='type',type=str,required=True,help='the species that you want to predict.'
                    'You can choose "H","M" and "S", which represent H. sapiens, M. musculus and S. cerevisiae, respectively.')
    parser.add_argument('--input',dest='inputfile',type=str,required=True,help='the input RNA sequence file with FASTA format. '
        'Please note that the length of input sequence must be 21-bp when the species is H. sapiens or M. musculus, and 31-bp when the species is S. cerevisiae.')
    parser.add_argument('--output',dest='outputfile',type=str,required=False,help='the output file name. The prediction results would be saved in csv format.')
